(function (factory) {
    ...
    $.fn.rating.defaults = {
        ...
        showCaption: true,
        starCaptionClasses: {
            0.5: 'label label-half labelRating',
            1: 'label label-one labelRating',
            1.5: 'label label-onenhalf labelRating',
            2: 'label label-two labelRating',
            2.5: 'label label-twonhalf labelRating',
            3: 'label label-three labelRating',
            3.5: 'label label-threenhalf labelRating',
            4: 'label label-four labelRating',
            4.5: 'label label-fournhalf labelRating',
            5: 'label label-five labelRating'
        },
